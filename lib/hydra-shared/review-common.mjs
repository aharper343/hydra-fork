...
import { getCurrentBranch, checkoutBranch, listBranches, getBranchDiffStat, getBranchDiff, getBranchLog, mergeBranch, deleteBranch } from './git-ops.mjs';
...
/**
 * Handle the interactive merge/skip/diff/delete prompt for a branch.
 *
 * @param {readline.Interface} rl
 * @param {string} projectRoot
 * @param {string} branch
 * @param {string} baseBranch
 * @returns {Promise<'merged'|'skipped'|'deleted'>}
 */
export async function handleBranchAction(rl, projectRoot, branch, baseBranch) {
