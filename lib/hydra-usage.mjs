...
export function parseStatsCache(filePath) {
  ...
  try {
    ...
    const dailyTokens = Array.isArray(data.dailyModelTokens)
    ...
    return {
      ...
      activity: dailyActivity ? {
        messageCount: dailyActivity.messageCount || 0,
        sessionCount: dailyActivity.sessionCount || 0,
        toolCallCount: dailyActivity.toolCallCount || 0,
      } : null,
      modelUsage,
