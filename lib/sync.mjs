#!/usr/bin/env node
/**
 * Multi-agent synchronization CLI for Codex + Claude Code + Gemini.
 *
 * Canonical state:
...
Commands:
  ...
  doctor              Detect local Codex/Claude/Gemini tooling
...
function buildPrompt(agent, state) {
  ...
  return [
    `You are ${agentLabel} collaborating in the ${config.projectName} repository with Codex, Claude Code, and Gemini Pro.`,
    '',
