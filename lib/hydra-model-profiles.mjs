...
export const MODEL_PROFILES = {
  ...
  'gpt-5.2-codex': {
    ...
    provider: 'openai',
    agent: 'codex',
    displayName: 'GPT-5.2 Codex (alias)',
    shortName: 'gpt-5.2',
    tier: 'flagship',
    contextWindow: 400_000,
    maxOutput: 128_000,
...
export const ROLE_DEFAULTS = {
  architect: {
    agent: 'claude',
    model: null,    // uses agent default (claude-opus-4-6)
    reasoningEffort: null,
    models: ['claude-opus-4-6', 'gpt-5.3-codex'],
    note: 'Best abstract reasoning (ARC-AGI-2 68.8%), #1 SWE-bench (80.8%)',
  },
  analyst: {
    agent: 'gemini',
    model: null,    // uses agent default (gemini-3-pro-preview)
    reasoningEffort: null,
    models: ['gemini-3-pro-preview', 'claude-opus-4-6'],
    note: 'Best Arena ELO (1,492), GPQA 91.9%, 1M native context',
  },
  implementer: {
    agent: 'codex',
    model: null,    // uses agent default (gpt-5.3-codex)
    reasoningEffort: null,
    models: ['gpt-5.3-codex', 'claude-sonnet-4-5-20250929'],
    note: 'Terminal-Bench SOTA (77.3%), fastest flagship (339 tok/s)',
  },
  concierge: {
    agent: 'codex',
    model: 'gpt-5',
...
export const AGENT_PRESETS = {
  claude: { default: 'claude-opus-4-6', fast: 'claude-sonnet-4-5-20250929', cheap: 'claude-haiku-4-5-20251001' },
  codex:  { default: 'gpt-5.3-codex',  fast: 'o4-mini',                    cheap: 'o4-mini' },
  gemini: { default: 'gemini-3-pro-preview', fast: 'gemini-3-flash-preview', cheap: 'gemini-3-flash-preview' },
};
