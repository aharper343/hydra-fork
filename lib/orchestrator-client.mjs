    ...
    switch (command) {
      ...
      case 'model': {
        ...
        for (const [agent, info] of Object.entries(summary)) {
          ...
          console.log(`  ${badge}  ${model} ${tag}`);
        }
        console.log('');
        console.log(DIM('  Set mode:  hydra model mode=economy'));
        console.log(DIM('  Override:  hydra model codex=gpt-5.3'));
      ...
      case 'init': {
        ...
        const initResult = spawnSync('node', [syncScript, 'init'], {
          cwd: process.cwd(),
          encoding: 'utf8',
          windowsHide: true,
        });
        ...
        const doctorResult = spawnSync('node', [syncScript, 'doctor'], {
          cwd: process.cwd(),
          encoding: 'utf8',
          windowsHide: true,
        });
