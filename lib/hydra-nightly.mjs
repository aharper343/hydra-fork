...
function checkoutDev(cwd) {
  checkoutBranch(cwd, 'dev');
}

function createNightlyBranch(cwd, branchName) {
  return createBranch(cwd, branchName, 'dev');
}
 ...
 */
function buildClaudePrompt(task, branchName, projectRoot, agent = 'claude') {
...
// executeAgent is now imported from hydra-shared/agent-executor.mjs
