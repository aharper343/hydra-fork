...
const DEFAULT_CONFIG = {
  ...
  roles: {
    concierge:      { agent: 'codex', model: 'gpt-5.2-codex', reasoningEffort: 'xhigh' },
    investigator:   { agent: 'codex', model: 'gpt-5.2-codex', reasoningEffort: 'high' },
    nightlyHandoff: { agent: 'codex', model: 'gpt-5.2-codex', reasoningEffort: null },
  ...
  recommendations: {
    concierge:      { models: ['gpt-5.2-codex', 'claude-sonnet-4-5-20250929'], reasoningEffort: 'xhigh', note: 'Needs fast streaming + broad knowledge for chat UX' },
    investigator:   { models: ['gpt-5.2-codex', 'gpt-5.3'], reasoningEffort: 'high', note: 'Needs strong reasoning for failure diagnosis' },
    nightlyHandoff: { models: ['gpt-5.2-codex', 'o4-mini'], reasoningEffort: null, note: 'Budget-saving agent — prefer cheap + fast' },
    architect:      { models: ['claude-opus-4-6', 'gpt-5.3'], reasoningEffort: null, note: 'Complex planning — use strongest available model' },
    analyst:        { models: ['gemini-2.5-pro', 'claude-opus-4-6'], reasoningEffort: null, note: 'Large context window helps for review tasks' },
