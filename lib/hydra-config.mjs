...
const DEFAULT_CONFIG = {
  ...
  models: {
    ...
    codex:  { default: 'gpt-5.3-codex', fast: 'o4-mini', cheap: 'o4-mini', active: 'default' },
  ...
  roles: {
    concierge:      { agent: 'codex', model: 'gpt-5', reasoningEffort: null },
    investigator:   { agent: 'codex', model: 'gpt-5.2', reasoningEffort: null },
    nightlyHandoff: { agent: 'codex', model: 'o4-mini', reasoningEffort: 'low' },
  ...
  recommendations: {
    concierge:      { models: ['gpt-5', 'claude-sonnet-4-5-20250929'], reasoningEffort: null, note: 'Needs fast streaming + broad knowledge for chat UX (GPT-5 has no reasoning control)' },
    investigator:   { models: ['gpt-5.2', 'gpt-5'], reasoningEffort: null, note: 'Needs strong reasoning for failure diagnosis (GPT-5 has no reasoning control)' },
    nightlyHandoff: { models: ['o4-mini', 'gpt-5'], reasoningEffort: 'low', note: 'Budget-saving agent — prefer cheap + fast; o4-mini supports low/medium/high effort' },
    architect:      { models: ['claude-opus-4-6', 'gpt-5.3-codex'], reasoningEffort: null, note: 'Complex planning — use strongest available model' },
    ...
    implementer:    { models: ['gpt-5.3-codex', 'claude-sonnet-4-5-20250929'], reasoningEffort: null, note: 'Fast execution with good instruction following' },
  },
  agents: {
    subAgents: {
      enabled: true,
  ...
  providers: {
    openai: { adminKey: null },
    anthropic: { adminKey: null },
    google: {},
  },
  doctor: {
    enabled: true,
...
function mergeWithDefaults(config) {
  ...
  return {
    ...
    modelRecovery: { ...DEFAULT_CONFIG.modelRecovery, ...parsed.modelRecovery },
