...
const DEFAULT_CONFIG = {
  ...
  roles: {
    ...
    investigator:   { agent: 'codex', model: 'gpt-5.2', reasoningEffort: 'high' },
  ...
  recommendations: {
    ...
    investigator:   { models: ['gpt-5.2', 'gpt-5'], reasoningEffort: 'high', note: 'Needs strong reasoning for failure diagnosis' },
